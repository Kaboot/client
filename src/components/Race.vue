...
<div>
  ...
  <div id="race">
      ...
      <input v-on:click.prevent="addScore(1)" id="myida" type="image" src="https://purepng.com/public/uploads/large/purepng.com-cloudnaturecloudsmoke-9615246757368kjiz.png" style="width:100px" >
      <button class="btn btn-success" id="myidb" ref="myidb" style="width: 100px; height:100px" v-on:click.prevent="addScore(1)">Nyamuk</button>
      <button class="btn btn-success" id="myidc" ref="myidc" style="width: 100px; height:100px" v-on:click.prevent="addScore(10)">Nyamuk</button>
      <button class="btn btn-success" id="myidd" ref="myidd" style="width: 100px; height:100px" v-on:click.prevent="addScore(1)">Nyamuk</button>
      <button class="btn btn-success" id="myide" ref="myide" style="width: 100px; height:100px" v-on:click.prevent="addScore(1)">Nyamuk</button>
